...
> [!NOTE] This bot is designed to work with my personal portfolio repository. Make sure to configure the GitHub integration with the correct repository and appropriate permissions.
